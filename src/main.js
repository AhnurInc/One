// =================================================================
// ARQUIVO DE SCRIPT CENTRAL - AHNUR INC. (VERSÃO DE CONTINGÊNCIA SEM CORS)
// =================================================================
  ...
  if (path.endsWith('servicos.html')) {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (mode === 'add') {
                ...
                finalServiceData.documents.forEach((newDoc) => {
    ...
    if (tableBody) {
        onSnapshot(query(collection(db, "servicos")), (snapshot) => {
            ...
            // LÓGICA REVERTIDA PARA O VISUALIZADOR
